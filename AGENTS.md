# Agent guide - threadlocal-kotlin

This file is the quick-reference operating contract for threadlocal-kotlin. The longer
...
threadlocal-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`threadlocal`](./README.md). Upstream Rust is the behavioral oracle while the
